...
CREATE TABLE `design_versions` (
  ...
  `version_label` varchar(150) DEFAULT NULL,
...
ALTER TABLE `design_versions`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `order_version_unique` (`order_id`,`version_number`),
...
--
ALTER TABLE `design_versions`
  ADD CONSTRAINT `design_versions_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`),
